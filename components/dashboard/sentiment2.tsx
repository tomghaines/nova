...
/*       const data = [
      ...
      const priceData = [
        ...
        { date: new Date(2024, 1, 1), price: 2.7 },
        { date: new Date(2024, 2, 1), price: 2.4 },
        { date: new Date(2024, 3, 1), price: 4.3 },
        { date: new Date(2024, 4, 1), price: 6.0 },
        { date: new Date(2024, 5, 1), price: 5.8 },
      ];
