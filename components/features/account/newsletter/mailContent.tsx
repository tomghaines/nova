...
export const MailContent: React.FC<MailContentProps> = ({ summary }) => {
  return (
    ...
    >
      ...
      >
        Here's your weekly dose of insights and trends happening in the Web3 world. Stay updated with the latest market
        shifts and narratives dominating the space.
      </p>
