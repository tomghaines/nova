...
export default function SentimentLayout() {
  ...
  return (
    <div className='border border-zinc-800 dark:border-zinc-100 '>
      ...
      <div className='ml-6 mt-4 flex h-6 w-1/6 items-center border text-center text-xs text-gray-800 border-zinc-400 dark:invert'>
      ...
      <div className='mb-8 ml-6 mr-6 mt-4 flex flex-col items-start justify-center border border-zinc-400'>
        <div className='flex flex-row justify-between items-centers w-full'>
          ...
          <div className='flex flex-row items-center mt-5 mb-5 ml-3'>
            <Avatar className='h-6 w-auto'>
              <AvatarImage src='https://cryptologos.cc/logos/bitcoin-btc-logo.png' />
              <AvatarFallback></AvatarFallback> 
            </Avatar>
            <h1 className='font-sans font-medium ml-2 text-lg'>Bitcoin (BTC)</h1>
          </div>
          {/* Right side: Select TimePeriod dropdown */}
          <select className='h-7 pl-1 pr-1 mr-3 border border-zinc-400 text-xs text-gray-800 leading-tight mt-5 dark:invert' value={timePeriod} onChange={(e) => setTimePeriod(e.target.value)}>
