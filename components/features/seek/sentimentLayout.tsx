...
export default function SentimentLayout() {
  ...
  return (
    <div className='border'>
      ...
      <div className='flex flex-row justify-between items-centers w-[700px] ml-10'>
        ...
        <select className='h-7 px-1 border border-gray-300 rounded text-xs leading-tight mt-5 dark:bg-gray-800 dark:text-grey-200' value={timePeriod} onChange={(e) => setTimePeriod(e.target.value)}>
