...
// import { ChevronDown, SlidersHorizontal, Info, BarChart2 } from 'lucide-react';
// import {
//   Tooltip,
//   TooltipContent,
//   TooltipProvider,
...
//     // Get latest data point for each name
...
//     return `rgb(${48 + Math.floor(normalizedValue * 140)}, ${10 + Math.floor(normalizedValue * 30)}, ${13 + Math.floor(normalizedValue * 38)})`;
//   };
...
//           <button
//             onClick={() =>
//               setView((v) => (v === 'treemap' ? 'list' : 'treemap'))
//             }
//             className='rounded-md bg-white/5 p-1 text-white/60 hover:bg-white/10'
//           >
//             <ChevronDown
//               className={`h-4 w-4 transition-transform ${view === 'list' ? 'rotate-180' : ''}`}
//             />
//           </button>
//         </div>
//       </div>
