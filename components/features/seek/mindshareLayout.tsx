...
export default function MindshareLayout() {
  ...
  return (
    <div className='mt-16 border border-zinc-800 dark:invert'>
      {/* Heading */}
      ...
      {/* Chart */}
      <div className='mb-8 ml-6 mr-6 mt-4 flex flex-col items-center justify-start border border-zinc-400'>
