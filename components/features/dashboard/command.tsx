  ...
  return (
    <div className='flex w-full items-center gap-5'>
      <div className='relative w-full'>
        <Command
          className='mx-auto h-auto w-full max-w-[860px] rounded-lg border border-zinc-100 shadow-lg dark:border-emerald-500 dark:shadow-neutral-800'
          ...
          {isTokenOpen && (
            <div className='absolute left-0 top-full z-50 w-full'>
              <CommandList
                ...
                className='bg-white shadow-lg dark:bg-neutral-900'
              >
